<template>
  <div>
    ...
    <div class='main-l-trat'>
      ...
      <nuxt-link to="/30/terca" class='dot-index'>Terça</nuxt-link>
      <nuxt-link to="/30/quarta" class='dot-index'>Quarta</nuxt-link>
      <nuxt-link to="/30/quinta" class='dot-index'>Quinta</nuxt-link>
      <nuxt-link to="/30/sexta" class='dot-index'>Sexta</nuxt-link>
      <nuxt-link to="/30/sabado" class='dot-index'>Sábado</nuxt-link>
    </div>
    <nuxt-child />
    <br>
    <!--
