<template>
  <div>
    ...
    <div class='main-l-trat'>
      <nuxt-link to="/20/segunda" class='dot-index'>Segunda</nuxt-link>
      <nuxt-link to="/20/terca" class='dot-index'>Terça</nuxt-link>
      <nuxt-link to="/20/quarta" class='dot-index'>Quarta</nuxt-link>
      <nuxt-link to="/20/quinta" class='dot-index'>Quinta</nuxt-link>
      <nuxt-link to="/20/sexta" class='dot-index'>Sexta</nuxt-link>
      <nuxt-link to="/20/sabado" class='dot-index'>Sábado</nuxt-link>
    </div>
    <nuxt-child />
    <br>
    <!--
