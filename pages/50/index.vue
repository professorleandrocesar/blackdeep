<template>
  <div>
    ...
    <div class='main-l-trat'>
      <nuxt-link to="/50/segunda" class='dot-index'>Segunda</nuxt-link>
      <nuxt-link to="/50/terca" class='dot-index'>Terça</nuxt-link>
      <nuxt-link to="/50/quarta" class='dot-index'>Quarta</nuxt-link>
      <nuxt-link to="/50/quinta" class='dot-index'>Quinta</nuxt-link>
      <nuxt-link to="/50/sexta" class='dot-index'>Sexta</nuxt-link>
      <nuxt-link to="/50/sabado" class='dot-index'>Sábado</nuxt-link>
    </div>
<nuxt-child />
    <br>
    <!--
